...
void FrameEffectRendererTest::render() {
	...
	frameEffects.addEffect(kke::ShadowEffect{{0.0f, 18.0f}, 24.0f, {0.02f, 0.04f, 0.08f, 0.22f}, kke::ShadowMode::ShadowWithSource});
	frameEffects.addEffect(kke::BlurEffect{{4.0f, kke::BlurBorderMode::SOFT, kke::BlurOptimization::BALANCED, kke::BlurMode::Normal}});
