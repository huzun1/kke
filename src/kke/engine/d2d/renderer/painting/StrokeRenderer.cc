...
void StrokeRenderer::draw(
	...
	context.getD2dContext()
		->getDeviceContext()
		->DrawLine({line.start.x, line.start.y}, {line.end.x, line.end.y}, brush, appearance.width);
}
...
void StrokeRenderer::draw(
	...
	context.getD2dContext()->getDeviceContext()->DrawGeometry(
		d2dGeometry.Get(),
		brush,
		appearance.width
	);
